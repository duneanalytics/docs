...
We have built custom functions to make it easier to work with varbinaries in DuneSQL. Check the [varbinary functions](/query/DuneSQL-reference/Functions-and-operators/varbinary/) page for more information.
...
See also [`date and time functions`](/query/DuneSQL-reference/Functions-and-operators/conversion/).
