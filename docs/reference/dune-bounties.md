...
In the **App Layer**, you can find [Queries](../getting-started/queries/index.md), [Visualizations](../getting-started/visualizations/index.md) and [Dashboards](../getting-started/dashboards.md). 
