...
!!! warning
    **Dune SQL exited alpha on March 2nd, 2023. We have made some changes to datatypes and column names that introduced breaking changes ** [See DuneSQL changes ](https://dune.com/docs/reference/dune-v2/dunesql-changes) for more.  
    For help with migrating queries to compatible data types and general Dune SQL functions, the best place to ask questions is on our[#dune-sql](https://discord.com/channels/757637422384283659/1051871389432422491) Discord channel.
