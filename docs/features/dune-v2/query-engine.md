...
![row oriented database (Postgres)](<../assets/image (84).png>)
...
![column oriented database (Spark)](<../assets/image (77).png>)
...
![schematic view of parquet files](<../assets/image (52).png>)
...
![schematic view of mix/max values](<../assets/minmax schema.JPG>)
