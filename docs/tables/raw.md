...
Most of the time you are better off [submitting contracts for decoding](/docs/features/adding-new-contracts.md) and working with [decoded data](../decoded-data/).
