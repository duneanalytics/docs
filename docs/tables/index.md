...
The details of the data model depends on the blockchain and engine. We've compiled detailed references for tables on our [Dune V1 Engine](v1-engine/) (PostgreSQL) and [Dune V2 Engine](v2-engine/) (SparkSQL).