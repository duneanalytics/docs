...
The Dune Data Engine takes this bytecode and extracts it into a set of Tables we call “[Raw Data](reference/tables/raw/index.md).”

These can vary slightly from chain to chain, but as an example, most [Ethereum Virtual Machine (EVM)](reference/tables/raw/traces.md) based chains include:



* [[chain].blocks](reference/tables/raw/blocks.md) - groups of transactions appended to the chain.
* [[chain].creation_traces](reference/tables/raw/traces.md) - transactions that contain [`create` traces](https://medium.com/coinmonks/ethereum-data-evm-traces-simplified-5e297e4f40a4) (sometimes these are in internal transactions)
* [[chain].logs](reference/tables/raw/event-logs.md) -  [event logs](https://medium.com/mycrypto/understanding-event-logs-on-the-ethereum-blockchain-f4ae7ba50378) created by smart contracts
* [[chain].traces](reference/tables/raw/traces.md) - [trace data](https://medium.com/coinmonks/ethereum-data-evm-traces-simplified-5e297e4f40a4) generated by transactions in a block
* [[chain].transactions](reference/tables/raw/transactions.md) - cryptographically signed instructions sent from one address to another.
...
This Raw Data can also take a lot more work to manipulate into interesting insights, which is why Dune [decodes](reference/tables/decoded/index.md) this data.
...
We then create [Decoded Tables](reference/tables/decoded/index.md) that are a lot easier to do analysis with.
...
With the help of our amazing community of Wizards, Dune goes a step beyond just decoding data with [Spells](reference/tables/spells/index.md).
